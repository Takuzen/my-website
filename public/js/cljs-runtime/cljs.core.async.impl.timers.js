...
var i_14346 = (0);
while(true){
if((i_14346 < arr.length)){
(arr[i_14346] = null);

var G__14348 = (i_14346 + (1));
i_14346 = G__14348;
continue;
} else {
}
...
var i_14366 = (self__.level + (1));
while(true){
if((i_14366 <= (new_level + (1)))){
(update[i_14366] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14374 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14374[i]));
} else {
x__$2.forward.push((((i < links_14374.length))?(links_14374[i]):null));
}

if((i < links_14374.length)){
(links_14374[i] = x__$2);
} else {
links_14374.push(x__$2);
}
...
var i_14382 = (0);
while(true){
if((i_14382 <= self__.level)){
var links_14383 = (update[i_14382]).forward;
if((x__$1 === (((i_14382 < links_14383.length))?(links_14383[i_14382]):null))){
(links_14383[i_14382] = (x__$1.forward[i_14382]));

var G__14385 = (i_14382 + (1));
i_14382 = G__14385;
continue;
} else {
var G__14386 = (i_14382 + (1));
i_14382 = G__14386;
continue;
}
} else {
