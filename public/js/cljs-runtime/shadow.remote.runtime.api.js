...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14305 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14305(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14312 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14312(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14316 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14316(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14330 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14330(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14333 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14333(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14336 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14336(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14296,callback){
var map__14297 = p__14296;
var map__14297__$1 = cljs.core.__destructure_map(map__14297);
var input = map__14297__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14297__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14297__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
